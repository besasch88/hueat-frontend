...
export interface PrinterEditModalComponentProps {
  isOpen: boolean;
...
export function PrinterEditModalComponent({ isOpen, printer, onClose, onUpdated }: PrinterEditModalComponentProps) {
  ...
  return (
    <Modal centered withCloseButton title={t('printerEdit')} opened={isOpen} onClose={onModalClose}>
      {isOpen && (
