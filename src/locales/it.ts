export const itTranslations = {
  ...
  printerTitle: 'Stampanti',
  printerAddNew: 'AGGIUNGI STAMPANTE',
  printerAdd: 'AGGIUNGI',
  printerEdit: 'MODIFICA STAMPANTE',
  printerSave: 'SALVA',
  printerInsertTitle: 'Inserisci nome stampante',
  printerInsertUrl: 'Inserisci URL stampante',
  printerEmptyList: 'Nessuna stampante configurata',
  printerEmptyListDescription: 'In questa area appariranno le stampanti di rete configurate.',
  printerDeleteTitle: 'ELIMINA STAMPANTE',
  printerDeleteConfirm: "Sei sicuro di voler eliminare questa stampante? L'operazione è irreversibile.",
  ...
  menuItemOutsidePrinterPlaceholder: 'Stampante per asporto',
  menuItemDeleteTitle: 'ELIMINA VOCE',
  menuItemDeleteConfirm: "Sei sicuro di voler eliminare questa voce di menu? L'operazione è irreversibile.",
  ...
  menuOptionInsidePrinterPlaceholder: 'Stampante per interno',
  menuOptionOutsideLabel: 'Asporto',
  menuOptionOutsidePrinterPlaceholder: 'Stampante per asporto',
